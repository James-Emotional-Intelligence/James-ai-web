...
<body>
  <div class="print-doc-container">
    ...
    `:""}
  `,h=u({title:"Kế Hoạch Học Tập & Chuẩn Bị Bài",subtitle:`Hôm nay: ${f(new Date)}`,documentTypeLabel:"Kế hoạch học tập ngày",studentName:p,gradeLevel:o,bodyContent:a});await b(h)}async function D(e,s){const c="Học sinh",o=e.filter(r=>r.priority==="high"),i=e.filter(r=>r.priority==="medium"),d=e.filter(r=>r.priority!=="high"&&r.priority!=="medium"),a=r=>r.length===0?'<p style="color: #94a3b8; font-style: italic; font-size: 10px;">Không có nhiệm vụ trong nhóm này.</p>':`
      <table class="data-table">
        <thead>
          <tr>
    ...
    `:""}
  `,t=u({title:"Danh Sách Nhiệm Vụ Học Tập GDPT 2018",subtitle:`Tổng cộng: ${e.length} nhiệm vụ | Xuất bản lúc: ${f(new Date)}`,documentTypeLabel:"Bảng nhiệm vụ học tập",studentName:c,gradeLevel:9,bodyContent:h});await b(t)}async function S(e,s,c){const p="Học sinh",i=s||e.executionGuide;let d='<p style="color: #64748b; font-style: italic;">Chưa có các bước hướng dẫn cụ thể.</p>';i&&i.steps&&i.steps.length>0&&(d=i.steps.map((t,r)=>`
  ...
  `,t=u({title:"Báo Cáo Tiến Độ & Hiệu Suất Học Tập",subtitle:`Đánh giá tổng hợp 7 ngày gần nhất | Khối ${p}`,documentTypeLabel:"Báo cáo học tập định kỳ",studentName:c,gradeLevel:p,bodyContent:h});await b(t)}async function I(e,s){const c=(s==null?void 0:s.studentName)||"Học sinh",p=(s==null?void 0:s.gradeLevel)||9,o=e.summaryJson||e.structuredSummary,i=(o==null?void 0:o.overview)||e.summary||"Tài liệu học tập chuẩn GDPT 2018.",d=(o==null?void 0:o.keyPoints)||[],a=(o==null?void 0:o.concepts)||[],h=(o==null?void 0:o.formulas)||[],t=`
    ...
    `:""}
  `,r=u({title:`Phiếu Tóm Tắt: ${e.title}`,subtitle:"Hệ thống hóa kiến thức cốt lõi tự động từ tài liệu học sinh",documentTypeLabel:"Phiếu tóm tắt tài liệu",studentName:c,gradeLevel:p,bodyContent:t});await b(r)}export{H as P,D as a,S as b,B as c,E as d,M as e,F as f,K as g,I as h};
