  ...
  public static seedUser(userId: string) {
    ...
    guideMap.set('task-math-1', {
      ...
      preparationChecklist: [
        { id: 'chk-1', text: 'Chuẩn bị thước kẻ và bút chì chuốt nhọn', checked: true },
        { id: 'chk-2', text: 'Mở trang 50 SGK Toán 9 tập 1', checked: true },
        { id: 'chk-3', text: 'Đặt bàn học gọn gàng, bật chế độ Không làm phiền', checked: false },
      ],
      steps: [
        {
          id: 'step-1',
    ...
    const exams: Exam[] = [
      {
        ...
        milestones: [
          { milestoneType: 'D-14', name: 'D-14: Ôn tập nền tảng', date: new Date(now.getTime() - 7 * 86400000).toISOString(), status: 'completed' },
          { milestoneType: 'D-7', name: 'D-7: Luyện đề tổng hợp', date: now.toISOString(), status: 'current' },
          { milestoneType: 'D-3', name: 'D-3: Rà soát lỗi sai', date: new Date(now.getTime() + 4 * 86400000).toISOString(), status: 'pending' },
          { milestoneType: 'D-1', name: 'D-1: Giữ tinh thần thoải mái', date: new Date(now.getTime() + 6 * 86400000).toISOString(), status: 'pending' },
        ],
      },
    ];
